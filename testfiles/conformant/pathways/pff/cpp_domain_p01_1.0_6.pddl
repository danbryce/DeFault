(define (domain GROUNDED-PATHWAYS-PROPOSITIONAL)
 ...
 (:action ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1
  :effect (and
    (when (and (and (available_cdk46p3-cycd) (available_dmp1)) (or (available_cdk46p3-cycd) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1_available_cdk46p3-cycd))) (valid)) (available_dmp1p1))
    (when (and (and (available_cdk46p3-cycd) (available_dmp1)) (or (available_cdk46p3-cycd) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1_available_cdk46p3-cycd))) (valid) (possclob_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1_available_dmp1)) (not (available_dmp1)))
    (when (not (and (and (available_cdk46p3-cycd) (available_dmp1)) (or (available_cdk46p3-cycd) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1_available_cdk46p3-cycd))) (valid))) (not (valid)))
  )
 )

 (:action ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1
  :effect (and
    (when (and (and (available_cdk46p3-cycdp1) (available_dmp1)) (or (available_cdk46p3-cycdp1) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1_available_cdk46p3-cycdp1))) (valid)) (available_dmp1p1))
    (when (and (and (available_cdk46p3-cycdp1) (available_dmp1)) (or (available_cdk46p3-cycdp1) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1_available_cdk46p3-cycdp1))) (valid) (possclob_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1_available_dmp1)) (not (available_dmp1)))
    (when (not (and (and (available_cdk46p3-cycdp1) (available_dmp1)) (or (available_cdk46p3-cycdp1) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1_available_cdk46p3-cycdp1))) (valid))) (not (valid)))
  )
 )
