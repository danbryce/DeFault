(define (domain GROUNDED-PATHWAYS-PROPOSITIONAL)
 ...
 (:action ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1
  :effect (and
    ...
    (when (and (and (available_cdk46p3-cycd) (available_dmp1)) (or (available_cdk46p3-cycd) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCD_DMP1P1_available_cdk46p3-cycd))) (valid)) (not (available_dmp1)))
