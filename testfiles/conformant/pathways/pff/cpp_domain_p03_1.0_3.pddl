(define (domain GROUNDED-PATHWAYS-PROPOSITIONAL)
 ...
 (:action ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2
  :effect (and
    (when (and (and (available_chk1) (available_cdc25c)) (or (available_chk1) (not (openprec_ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2_available_chk1))) (valid)) (available_cdc25cp2))
    (when (and (and (available_chk1) (available_cdc25c)) (or (available_chk1) (not (openprec_ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2_available_chk1))) (valid) (possclob_ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2_available_cdc25c)) (not (available_cdc25c)))
    (when (not (and (and (available_chk1) (available_cdc25c)) (or (available_chk1) (not (openprec_ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2_available_chk1))) (valid))) (not (valid)))
  )
 )
 ...
 (:action ASSOCIATE_PRB_E2F4-DP12P1_PRB-E2F4-DP12P1
  :effect (and
    (when (and (and (available_prb) (available_e2f4-dp12p1)) (valid) (unlistedeffect_ASSOCIATE_PRB_E2F4-DP12P1_PRB-E2F4-DP12P1_available_prb-e2f4-dp12p1)) (available_prb-e2f4-dp12p1))
    (when (and (and (available_prb) (available_e2f4-dp12p1)) (valid) (possclob_ASSOCIATE_PRB_E2F4-DP12P1_PRB-E2F4-DP12P1_available_prb)) (not (available_prb)))
    (when (and (and (available_prb) (available_e2f4-dp12p1)) (valid) (possclob_ASSOCIATE_PRB_E2F4-DP12P1_PRB-E2F4-DP12P1_available_e2f4-dp12p1)) (not (available_e2f4-dp12p1)))
