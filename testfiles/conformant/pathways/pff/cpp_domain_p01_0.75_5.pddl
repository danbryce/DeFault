(define (domain GROUNDED-PATHWAYS-PROPOSITIONAL)
 ...
 (:action ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1
  :effect (and
    ...
    (when (and (and (available_cdk46p3-cycdp1) (available_dmp1)) (or (available_cdk46p3-cycdp1) (not (openprec_ASSOCIATE-WITH-CATALYZE_DMP1_CDK46P3-CYCDP1_DMP1P1_available_cdk46p3-cycdp1))) (valid)) (not (available_dmp1)))
