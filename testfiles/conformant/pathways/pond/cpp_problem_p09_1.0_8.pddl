(define (problem GROUNDED-PATHWAYS-09)
 ...
 (:init
  ...
  (probabilistic 0.5 (possclob_ASSOCIATE-WITH-CATALYZE_CDK1P1_CDK7-CYCH_CDK1P1P3_available_cdk1p1))
  ...
  (probabilistic 0.5 (possclob_ASSOCIATE-WITH-CATALYZE_CDK1P1P2P3_CDC25CP1P2_CDK1P2P3_available_cdk1p1p2p3))
