(define (domain GROUNDED-PATHWAYS-PROPOSITIONAL)
 ...
 (:action ASSOCIATE_PRBP1_E2F4-DP12P1_PRBP1-E2F4-DP12P1
  :effect (and
    (when (and (and (available_prbp1) (available_e2f4-dp12p1)) (valid)) (available_prbp1-e2f4-dp12p1))
    (when (and (and (available_prbp1) (available_e2f4-dp12p1)) (valid)) (not (available_prbp1)))
    (when (and (and (available_prbp1) (available_e2f4-dp12p1)) (valid)) (not (available_e2f4-dp12p1)))
