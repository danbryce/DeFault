(define (domain GROUNDED-PATHWAYS-PROPOSITIONAL)
 ...
 (:action ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2
  :effect (and
    ...
    (when (and (and (available_chk1) (available_cdc25c)) (or (available_chk1) (not (openprec_ASSOCIATE-WITH-CATALYZE_CDC25C_CHK1_CDC25CP2_available_chk1))) (valid)) (not (available_cdc25c)))
