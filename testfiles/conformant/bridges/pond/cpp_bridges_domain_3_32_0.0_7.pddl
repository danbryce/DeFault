(define (domain Bridges)
 ...
 (:action pickup_treasure1
  :effect (and
    ...
    (when (and (at_31_0) (valid) (unlistedeffect_pickup_treasure1_holding_treasure_2)) (holding_treasure_2))
