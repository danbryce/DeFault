(define (domain Bridges)
 ...
 (:action pickup_treasure2
  :effect (and
    ...
    (when (and (at_31_31) (valid) (unlistedeffect_pickup_treasure2_holding_treasure_3)) (holding_treasure_3))
    (when (and (at_31_31) (valid) (unlistedeffect_pickup_treasure2_holding_treasure_1)) (holding_treasure_1))
    (when (not (and (at_31_31) (valid))) (not (valid)))
  )
 )
 ...
 (:action pickup_treasure3
  :effect (and
    ...
    (when (and (at_0_31) (valid) (unlistedeffect_pickup_treasure3_holding_treasure_1)) (holding_treasure_1))
    (when (not (and (at_0_31) (valid))) (not (valid)))
  )
 )
