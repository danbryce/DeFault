(define (domain Bridges)
 ...
 (:action pickup_treasure2
  :effect (and
    ...
    (when (and (at_1_1) (valid) (unlistedeffect_pickup_treasure2_holding_treasure_1)) (holding_treasure_1))
 ...
 (:action pickup_treasure3
  :effect (and
    ...
    (when (and (at_0_1) (valid) (unlistedeffect_pickup_treasure3_holding_treasure_2)) (holding_treasure_2))
