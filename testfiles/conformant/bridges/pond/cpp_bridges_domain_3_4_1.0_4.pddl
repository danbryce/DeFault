(define (domain Bridges)
 ...
 (:action pickup_treasure3
  :effect (and
    ...
    (when (and (at_0_3) (valid) (unlistedeffect_pickup_treasure3_holding_treasure_2)) (holding_treasure_2))
