(define (domain BlindNav)
 ...
 (:action observe_high_11_2_12_2
  :effect (and
    (when (and (near_11_2) (near_12_2) (valid)) (found))
    (when (not (and (near_11_2) (near_12_2) (valid))) (not (valid)))
  )
 )

 (:action observe_high_11_2_11_3
  :effect (and
    (when (and (near_11_2) (near_11_3) (valid)) (found))
