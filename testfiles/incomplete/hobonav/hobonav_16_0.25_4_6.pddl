...
(:action easymark_road_stake_4_1
 :parameters ()
 :precondition (and (at_4_1))
 :effect (and (have_road_stake))
)
...
(:action easymark_road_stake_4_3
 :parameters ()
 :precondition (and (at_4_3))
 :effect (and (have_road_stake))
)
...
(:action easymark_glad_rags_7_14
 :parameters ()
 :precondition (and (at_7_14))
 :effect (and (have_glad_rags))
)
...
(:action easymark_glad_rags_14_10
 :parameters ()
 :precondition (and (at_14_10))
 :effect (and (have_glad_rags))
)
...
(:action easymark_glad_rags_15_4
 :parameters ()
 :precondition (and (at_15_4))
 :effect (and (have_glad_rags))
)

(:action easymark_road_stake_15_5
 :parameters ()
 :precondition (and (at_15_5))
 :effect (and (have_road_stake))
)
