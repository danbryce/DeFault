...
(:action easymark_road_stake_0_4
 :parameters ()
 :precondition (and (at_0_4))
...
(:action easymark_california_blankets_1_14
 :parameters ()
 :precondition (and (at_1_14))
 :effect (and (have_california_blankets))
)
...
(:action easymark_road_stake_2_6
 :parameters ()
 :precondition (and (at_2_6))
 :effect (and (have_road_stake))
)
...
(:action easymark_glad_rags_5_10
 :parameters ()
 :precondition (and (at_5_10))
 :effect (and (have_glad_rags))
)
...
(:action easymark_california_blankets_8_5
 :parameters ()
 :precondition (and (at_8_5))
 :effect (and (have_california_blankets))
)
...
(:action easymark_glad_rags_8_6
 :parameters ()
 :precondition (and (at_8_6))
 :effect (and (have_glad_rags))
)

(:action easymark_bindle_8_7
 :parameters ()
 :precondition (and (at_8_7))
 :effect (and (have_bindle))
)

(:action easymark_road_stake_8_14
 :parameters ()
 :precondition (and (at_8_14))
 :effect (and (have_road_stake))
)
...
(:action easymark_glad_rags_10_15
 :parameters ()
 :precondition (and (at_10_15))
 :effect (and (have_glad_rags))
)
