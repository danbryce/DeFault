...
(:action easymark_california_blankets_2_5
 :parameters ()
 :precondition (and (at_2_5))
 :effect (and (have_california_blankets))
)
...
(:action easymark_california_blankets_4_9
 :parameters ()
 :precondition (and (at_4_9))
 :effect (and (have_california_blankets))
)
...
(:action easymark_california_blankets_10_12
 :parameters ()
 :precondition (and (at_10_12))
 :effect (and (have_california_blankets))
)
...
(:action easymark_california_blankets_15_7
 :parameters ()
 :precondition (and (at_15_7))
 :effect (and (have_california_blankets))
)
