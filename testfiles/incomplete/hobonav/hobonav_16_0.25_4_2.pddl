...
(:action easymark_glad_rags_2_8
 :parameters ()
 :precondition (and (at_2_8))
 :effect (and (have_glad_rags))
)

(:action easymark_bindle_2_11
 :parameters ()
 :precondition (and (at_2_11))
 :effect (and (have_bindle))
)
...
(:action easymark_glad_rags_3_3
 :parameters ()
 :precondition (and (at_3_3))
 :effect (and (have_glad_rags))
)

(:action easymark_road_stake_3_3
 :parameters ()
 :precondition (and (at_3_3))
 :effect (and (have_road_stake))
)
...
(:action easymark_road_stake_11_2
 :parameters ()
 :precondition (and (at_11_2))
 :effect (and (have_road_stake))
)
...
(:action easymark_glad_rags_11_13
 :parameters ()
 :precondition (and (at_11_13))
 :effect (and (have_glad_rags))
)
