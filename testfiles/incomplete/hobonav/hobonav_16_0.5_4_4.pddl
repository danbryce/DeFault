...
(:action easymark_california_blankets_5_6
 :parameters ()
 :precondition (and (at_5_6))
 :effect (and (have_california_blankets))
)
...
(:action easymark_glad_rags_10_4
 :parameters ()
 :precondition (and (at_10_4))
 :effect (and (have_glad_rags))
)
...
(:action easymark_glad_rags_10_14
 :parameters ()
 :precondition (and (at_10_14))
 :effect (and (have_glad_rags))
)

(:action easymark_road_stake_10_14
 :parameters ()
 :precondition (and (at_10_14))
 :effect (and (have_road_stake))
)
