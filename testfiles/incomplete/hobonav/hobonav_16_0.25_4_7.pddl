...
(:action easymark_glad_rags_6_13
 :parameters ()
 :precondition (and (at_6_13))
 :effect (and (have_glad_rags))
)
...
(:action easymark_california_blankets_10_1
 :parameters ()
 :precondition (and (at_10_1))
 :effect (and (have_california_blankets))
)
...
(:action easymark_road_stake_10_8
 :parameters ()
 :precondition (and (at_10_8))
 :effect (and (have_road_stake))
)
...
(:action easymark_glad_rags_12_4
 :parameters ()
 :precondition (and (at_12_4))
 :effect (and (have_glad_rags))
)
