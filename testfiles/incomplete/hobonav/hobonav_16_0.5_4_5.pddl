...
(:action easymark_bindle_1_9
 :parameters ()
 :precondition (and (at_1_9))
 :effect (and (have_bindle))
)

(:action easymark_bindle_1_10
 :parameters ()
 :precondition (and (at_1_10))
 :effect (and (have_bindle))
)
...
(:action easymark_road_stake_2_11
 :parameters ()
 :precondition (and (at_2_11))
 :effect (and (have_road_stake))
)
...
(:action easymark_road_stake_7_13
 :parameters ()
 :precondition (and (at_7_13))
 :effect (and (have_road_stake))
)

(:action easymark_bindle_7_14
 :parameters ()
 :precondition (and (at_7_14))
 :effect (and (have_bindle))
)
...
(:action easymark_glad_rags_10_7
 :parameters ()
 :precondition (and (at_10_7))
 :effect (and (have_glad_rags))
)
...
(:action easymark_california_blankets_11_14
 :parameters ()
 :precondition (and (at_11_14))
 :effect (and (have_california_blankets))
)
