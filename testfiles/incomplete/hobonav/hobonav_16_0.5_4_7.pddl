...
(:action easymark_road_stake_3_12
 :parameters ()
 :precondition (and (at_3_12))
 :effect (and (have_road_stake))
)
...
(:action easymark_california_blankets_7_2
 :parameters ()
 :precondition (and (at_7_2))
 :effect (and (have_california_blankets))
)
...
(:action easymark_road_stake_9_5
 :parameters ()
 :precondition (and (at_9_5))
 :effect (and (have_road_stake))
)
...
(:action easymark_california_blankets_11_3
 :parameters ()
 :precondition (and (at_11_3))
 :effect (and (have_california_blankets))
)
...
(:action easymark_bindle_13_10
 :parameters ()
 :precondition (and (at_13_10))
 :effect (and (have_bindle))
)

(:action easymark_glad_rags_13_13
 :parameters ()
 :precondition (and (at_13_13))
 :effect (and (have_glad_rags))
)
