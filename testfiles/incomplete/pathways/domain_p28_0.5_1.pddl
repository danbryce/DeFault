...
:poss-effect
(and
(not (available_raf1-prbp1-e2f13-dp12p1-ge2))
(available_cycd)
)
)
...
:poss-effect
(and 
(not (available_jun-c-fos-gercc1))
)
)
...
:poss-effect
(and
(not (available_prbp1-jun-c-fos-gercc1))
(available_ercc1)
)
)
...
:poss-effect
(and 
(not (available_prbp1p2-jun-c-fos-gercc1))
)
)
...
:poss-effect
(and
(not (available_prbp2-jun-c-fos-gercc1))
(available_ercc1)
)
)
...
:poss-effect
(and
(not (available_raf1-prb-e2f13-dp12p1-ge2))
(available_cyca)
)
)
