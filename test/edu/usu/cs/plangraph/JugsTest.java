...
public class JugsTest
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        DefaultProblem jugsProblem = createJugsProblem(jugs);
    ...
    public static Domain createJugsDomain() {
        ...
        // Fill action
        DefaultGoalDesc precond = new ComparisonGoalDesc("<", 
        ...
        precond = new ComparisonGoalDesc(">", 
                                         ...
                                         new PDDLNumber(0));
        DefaultGoalDesc when1cond = new ComparisonGoalDesc("<=", 
        ...
        DefaultGoalDesc when2cond = new ComparisonGoalDesc(">", 
            new BinaryArithmeticExpr("+", new FunctionHeader(contents, Arrays.asList(j1Arg)), 
                                     new FunctionHeader(contents, Arrays.asList(j2Arg))),
            new FunctionHeader(capacity, Arrays.asList(j2Arg)));
    ...
    public static DefaultProblem createJugsProblem(Domain jugs) throws InconsistentLiteralException {
        PDDLType jugType = new PDDLType("jug");
        ...
        return new DefaultProblem("jugs1", jugs, objects, startState, goal);
    }
}
