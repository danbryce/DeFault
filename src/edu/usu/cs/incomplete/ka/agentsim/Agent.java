...
{	
	...
	public Agent(Domain d, Problem p)
	{
		...
		setCountOfActionsThatAreTrulyInitiallyIncomplete();
	...
	public static boolean isActionComplete(IncompleteActionInstance a)
	{
	...
	void setCountOfActionsThatAreTrulyInitiallyIncomplete()
	{
		totalOriginalIncompleteActions = 0;
		
		for(IncompleteActionInstance a: incompleteActionInstances.values())
		{
			boolean isActionComplete = Agent.isActionComplete(a);
			if(!isActionComplete)
			{
				totalOriginalIncompleteActions++;
			}
		}
	}
