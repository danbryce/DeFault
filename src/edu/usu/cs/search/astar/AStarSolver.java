...
public class AStarSolver
{
	...
	public AStarSolver(Domain domain, Problem problem) throws IllDefinedProblemException
	{
		...
		astar = new AStarSearch(domain, problem, actionInstances, new ClassicalSolutionEvaluator());
		astar.initClassicalAStar();
	}
