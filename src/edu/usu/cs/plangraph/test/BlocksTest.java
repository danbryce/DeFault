...
public class BlocksTest
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        Problem blocksProblem = createBlocks1Problem(blocks);
    ...
    public static Domain createBlocksDomain() {
        ...
        // Pickup action
        GoalDesc precond = new ConjunctionGoalDesc(Arrays.asList(
    ...
    public static Problem createBlocks1Problem(Domain blocks) throws InconsistentLiteralException {
        ...
        return new Problem("blocks1", blocks, objects, startState, goal);
    }
}
