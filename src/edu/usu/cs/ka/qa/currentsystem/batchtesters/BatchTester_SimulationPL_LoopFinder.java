...
import edu.usu.cs.ka.qa.currentsystem.simulator.SimulationPL_LoopFinder;

public class BatchTester_SimulationPL_LoopFinder 
{
			...
			{	
				for(int version = 1; version <= 3; version++)//1-3
				{
					for(int numFile = 1; numFile <= 10; numFile++) //numFiles 1-10
					{
						...
						try{ SimulationPL_LoopFinder.main(args); }
