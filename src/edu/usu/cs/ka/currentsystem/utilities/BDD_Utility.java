...
public class BDD_Utility 
{
	...
	public static void main(String[] args)
	{
		...
		Fault risk = Fault.getRiskFromIndex(Fault.POSSADD, currAct.getName(), Proposition.getPropositionFromIndex("have_bindle"));
		...
		//We must encode this new knowledge in the BDD.
		//The risk associated with this knowledge piece is:
		Fault risk2 = Fault.getRiskFromIndex(Fault.POSSDEL, currAct.getName(), Proposition.getPropositionFromIndex("have_bindle"));
		//Prove we got the risk:
		...
		Fault risk3 = Fault.getRiskFromIndex(Fault.POSSDEL, currAct.getName(), Proposition.getPropositionFromIndex("have_bindle"));
		//Let's query the BDD to see what it says about this risk.
