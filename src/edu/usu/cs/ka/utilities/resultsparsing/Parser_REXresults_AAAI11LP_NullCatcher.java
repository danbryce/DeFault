...
public class Parser_REXresults_AAAI11LP_NullCatcher 
{	
	...
	static String bigResultsFolder = "out/";
	static String outputFolderDateTimeAppend = "AAAI11LP_3.22.11_NULLEDor";
					...
					try 
					{
						...
						while (scanner.hasNextLine()) 
						{
							...
							if(line.contains("cweber") && !line.contains("File") && !line.contains("#"))
							{
								...
								if(!line.contains("?") && !line.contains("n") )
									results.add(line);
	...
	static String getResultsWithNullsInNoneStratAndEliminateNoneAndLoopStrats(String line)
	{
		String[] lineTokens = line.split(" ");
