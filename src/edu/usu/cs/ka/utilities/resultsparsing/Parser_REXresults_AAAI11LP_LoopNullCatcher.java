package edu.usu.cs.ka.utilities.resultsparsing;
import java.util.*;
import java.io.*;

public class Parser_REXresults_AAAI11LP_LoopNullCatcher 
{	
	...
	static String bigResultsFolder = "out/";
	static String outputFolderDateTimeAppend = "AAAI11LP_3.22.11_LOOPEDand";

	static boolean isLineCleaner = true;
	static boolean isOred 		 = false; //if false, then isAnd'd
					...
					try 
					{
						...
						while (scanner.hasNextLine()) 
						{
							...
							if(line.contains("cweber") && !line.contains("File"))
							{
								...
								line = getResultsWithLoopsInNoneStratAndEliminateNoneStrat(line);
							...
							if(line.contains("Exception") && !metaResult.contains("*") && !line.contains("#"))
								metaResult += "* ";
	...
	static String getResultsWithLoopsInNoneStratAndEliminateNoneStrat(String line)
	{
		String[] lineTokens = line.split(" ");
