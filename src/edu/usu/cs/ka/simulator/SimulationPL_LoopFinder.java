package edu.usu.cs.ka.simulator;

import java.util.*;

import edu.usu.cs.heuristic.stanplangraph.incomplete.BDDRiskSet;
import edu.usu.cs.ka.agentsystem.*;
import edu.usu.cs.ka.agentsystem.Agent.AgentTypes;
import edu.usu.cs.ka.agentsystem.Agent.LearningTypes;
import edu.usu.cs.ka.agentsystem.Planner.PlannerTypes;
import edu.usu.cs.ka.agentsystem.QA.QA_Types;
...
/**
 * Planner time limit is now 10 secs, not 20 minutes
 * outputs result even if no solutions found
 *
 */
public class SimulationPL_LoopFinder
{		
	...
	PlannerTypes pType;
	static SimulationPL_LoopFinder instance;
	...
	public static final int plannerTimeLimit = 10; //20 minutes = 1200
		
	SimulationPL_LoopFinder(String[] args, int simSeed)
	{					
	...
	public static SimulationPL_LoopFinder getInstance() {return instance;}//Incomplete v. of singleton pattern assumes instance always previously exists.
...
//		System.out.println();
		...
		{		
			try
			{
				SimulationPL_LoopFinder sim = new SimulationPL_LoopFinder(args, simSeed);
