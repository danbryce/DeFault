 ...
 */
public class Test_PlannerRawPerformance_version 
{	
	public static int numSuccesses = 0;
	
	Test_PlannerRawPerformance_version(String [] args)
	{		
	...
	{	
		Test_PlannerRawPerformance_version trial = new Test_PlannerRawPerformance_version(args);
		...
		//else System.out.print("Complete Amir " + plan.size() + " " + planners.getTimeToSolve() + " ");
