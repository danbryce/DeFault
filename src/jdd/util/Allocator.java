...
public class Allocator {
	private static long int_s = 0, int_c = 0, short_s = 0, short_c = 0, double_c = 0, bigInteger_c = 0;
	private static long char_s = 0, char_c = 0, byte_s = 0, byte_c = 0, double_s = 0, bigInteger_s = 0;
	private static long int_t = 0, short_t = 0, char_t = 0, byte_t = 0, double_t = 0, bigInteger_t =0;
	...
	/** allocate an array of BigIntgers */
	public static BigInteger [] allocateBigIntegerArray(int size) {

		if(bigInteger_s < size) bigInteger_s = size;
		bigInteger_c ++;
		bigInteger_t += size;
		try {
			// System.gc();
